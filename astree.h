...
extern PROCFUNCDEF *make_procfunc_def (DECLLIST *dl, IDENT *ret, BLOCK *blk);
...
extern DECL   *make_procfunc_decl (IDENT *id, DECLLIST *dl, IDENT *ret, BLOCK *blk);
...
extern FIELD *make_field         (IDENT *fid, TYPE *ftyp);
...
extern STMTIF     *make_stmtif     (EXPR *e, STMT *t, STMT *el);
extern CASEARM    *make_casearm    (EXPRLIST *el, STMT *s);
extern CASELIST   *make_caselist   (CASEARM *ca, CASELIST *cl);
extern STMTREPEAT *make_stmtrepeat (EXPR *e, STMTLIST *sl);
extern STMTFOR    *make_stmtfor    (IDENT *id, EXPR *fi, BOOLEAN up, EXPR *ft, STMT *fs);

/* statement constructor functions */

extern STMT *make_compound_stmt (STMTLIST *sl);
extern STMT *make_if_stmt       (EXPR *e, STMT *t, STMT *el);
extern STMT *make_case_stmt     (EXPR *e, CASELIST *cl);
extern STMT *make_repeat_stmt   (EXPR *e, STMTLIST *sl);
extern STMT *make_for_stmt      (IDENT *id, EXPR *fi, BOOLEAN up, EXPR *ft, STMT *fs);
