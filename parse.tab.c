...
#line 176 "parse.tab.c" /* yacc.c:355  */
};
...
static const char *const yytname[] =
{
  ...
  "ForStatement", "Direction", YY_NULLPTR
};
#endif
...
#line 85 "parse.y" /* yacc.c:1646  */
    { DECLLIST *dl = make_decllist (make_program_decl ((yyvsp[-3].id)), 0);
	        (yyval.prog_) = make_program (dl, (yyvsp[-1].block_));
	      }
...
#line 92 "parse.y" /* yacc.c:1646  */
    { 
        ...
        */   
            (yyval.block_) = make_block ((yyvsp[-3].decllist_), (yyvsp[-1].stmtlist_)); 
          }
...
#line 112 "parse.y" /* yacc.c:1646  */
    { (yyval.decllist_) = (yyvsp[0].decllist_); }
...
#line 118 "parse.y" /* yacc.c:1646  */
    { (yyval.decllist_) = make_decllist ((yyvsp[-1].decl_), (yyvsp[0].decllist_)); }
...
#line 135 "parse.y" /* yacc.c:1646  */
    { (yyval.decl_) = make_const_decl ((yyvsp[-3].id), (yyvsp[-1].expr_)); }
...
#line 152 "parse.y" /* yacc.c:1646  */
    { (yyval.decl_) = make_type_decl ((yyvsp[-3].id), (yyvsp[-1].type_)); }
...
#line 164 "parse.y" /* yacc.c:1646  */
    { 
            DECL *d = make_var_decl ((yyvsp[-4].id), (yyvsp[-2].type_));
            (yyval.decllist_) = make_decllist (d, (yyvsp[0].decllist_));
          }
...
#line 169 "parse.y" /* yacc.c:1646  */
    { 
            if ((yyvsp[0].decllist_) && (yyvsp[0].decllist_)->this && (yyvsp[0].decllist_)->this->tag == DeclVar_) {
	            DECL *d = make_var_decl ((yyvsp[-2].id), (yyvsp[0].decllist_)->this->d.var->var_type);
	            (yyval.decllist_) = make_decllist (d, (yyvsp[0].decllist_));
	        }
            else
              (yyval.decllist_) = (yyvsp[0].decllist_) ;
...
#line 240 "parse.y" /* yacc.c:1646  */
    { (yyval.type_) = make_range_type ((yyvsp[-2].expr_), (yyvsp[0].expr_)); }
#line 1658 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 43:
#line 242 "parse.y" /* yacc.c:1646  */
    { (yyval.type_) = make_enum_type ((yyvsp[-1].bindlist_)); }
#line 1664 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 44:
#line 247 "parse.y" /* yacc.c:1646  */
    { (yyval.bindlist_) = make_bindlist (make_binding ((yyvsp[0].id)),  0); }
#line 1670 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 45:
#line 249 "parse.y" /* yacc.c:1646  */
    { (yyval.bindlist_) = make_bindlist (make_binding ((yyvsp[-2].id)), (yyvsp[0].bindlist_)); }
...
#line 272 "parse.y" /* yacc.c:1646  */
    { (yyval.fieldlist_) = (yyvsp[0].fieldlist_); }
...
#line 290 "parse.y" /* yacc.c:1646  */
    { (yyval.decllist_) = (yyvsp[-1].decllist_); }
...
#line 297 "parse.y" /* yacc.c:1646  */
    { varmode = (yyvsp[0].mode_); /* this "passes forward" the mode for the group */ }
...
#line 304 "parse.y" /* yacc.c:1646  */
    { (yyval.decl_) = make_formal_decl ((yyvsp[-2].id), varmode, make_id_type ((yyvsp[0].id))); }
...
#line 308 "parse.y" /* yacc.c:1646  */
    { 
            if ((yyvsp[0].decllist_) && (yyvsp[0].decllist_)->this && (yyvsp[0].decllist_)->this->d.frm) {
              FORMAL *old = (yyvsp[0].decllist_)->this->d.frm;
              DECL *d = make_formal_decl ((yyvsp[-2].id), old->frm_mode, old->frm_type);
              (yyval.decllist_) = make_decllist (d, (yyvsp[0].decllist_));
            }
            else
              (yyval.decllist_) = (yyvsp[0].decllist_);
...
#line 345 "parse.y" /* yacc.c:1646  */
    { (yyval.stmt_) = make_assign_stmt ((yyvsp[-2].expr_), (yyvsp[0].expr_)); }
#line 1816 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 71:
#line 350 "parse.y" /* yacc.c:1646  */
    { (yyval.stmt_) = make_call_stmt ((yyvsp[0].expr_)); }
...
#line 361 "parse.y" /* yacc.c:1646  */
    { (yyval.expr_) = make_call_expr ((yyvsp[-4].id), make_exprlist ((yyvsp[-2].expr_), (yyvsp[-1].exprlist_))); }
...
#line 368 "parse.y" /* yacc.c:1646  */
    { (yyval.exprlist_) = make_exprlist ((yyvsp[-1].expr_), (yyvsp[0].exprlist_)); }
#line 1846 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 80:
#line 373 "parse.y" /* yacc.c:1646  */
    { (yyval.expr_) = make_bin_expr ('[', (yyvsp[-2].expr_), (yyvsp[-1].expr_)); }
#line 1852 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 81:
#line 375 "parse.y" /* yacc.c:1646  */
    { (yyval.expr_) = make_bin_expr ('.', (yyvsp[-2].expr_), make_id_expr ((yyvsp[0].id))); }
#line 1858 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 82:
#line 377 "parse.y" /* yacc.c:1646  */
    { (yyval.expr_) = make_un_expr ('^', (yyvsp[-1].expr_)); }
...
#line 391 "parse.y" /* yacc.c:1646  */
    { (yyval.expr_) = make_bin_expr ((yyvsp[-1].ival), (yyvsp[-2].expr_), (yyvsp[0].expr_)); }
...
#line 427 "parse.y" /* yacc.c:1646  */
    { (yyval.expr_) = make_un_expr (NOT_, (yyvsp[0].expr_)); }
...
#line 507 "parse.y" /* yacc.c:1646  */
    { (yyval.caselist_) = make_caselist (0, (yyvsp[0].caselist_)); }
...
#line 524 "parse.y" /* yacc.c:1646  */
    { (yyval.exprlist_) = make_exprlist ((yyvsp[0].expr_),  0); }
#line 2020 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 127:
#line 526 "parse.y" /* yacc.c:1646  */
    { (yyval.exprlist_) = make_exprlist ((yyvsp[-2].expr_), (yyvsp[0].exprlist_)); }
#line 2026 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 128:
#line 531 "parse.y" /* yacc.c:1646  */
    { (yyval.stmt_) = make_whilestmt ((yyvsp[-2].expr_), (yyvsp[0].stmt_)); }
#line 2032 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 129:
#line 541 "parse.y" /* yacc.c:1646  */
    { (yyval.stmt_) = make_repeat_stmt ((yyvsp[0].expr_), (yyvsp[-2].stmtlist_)); }
